...
export default function Home() {
  ...
  return (
    <div className=''>
      ...
      <select className="block text-black w-1/ p-2 mb-4 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-purple-500 focus:border-purple-500">
