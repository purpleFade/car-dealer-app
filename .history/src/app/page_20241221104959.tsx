...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <select onChange={ handleNameChange() } className='block text-black w-1/2 p-2 mb-4 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-purple-500 focus:border-purple-500'>
